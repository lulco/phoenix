...
### Composer
This library requires PHP 7.4 or 8.0. It also should work on PHP 8.1. The fastest and recommended way to install Phoenix is to add it to your project using Composer (https://getcomposer.org/).
